...
<div class="container text-center">
        <div class="row">
            ...
            <div class="col">
                <a target="_blank" href="pdf/orden_kOx123.pdf" type="image" name="imageField3"class="btn-lg bg-warning text-white " style="border:0px;" data-toggle="tooltip" data-placement="top"
